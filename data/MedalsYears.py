...
plt.plot(Years, GoldMedals, color=('gold'), linewidth=3.0, label='Gold Medals')
plt.plot(Years, SilverMedals, color=('silver'), linewidth=3.0, label='Silver Medals')
plt.plot(Years, BronzeMedals, color=('darkgoldenrod'), linewidth=3.0, label='Bronze Medals')
